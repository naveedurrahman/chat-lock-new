...
@section('content')
    <div class="container-xl">
        ...
        <div class="boxes">
            ...
            <div class="title">Inctive Client
                ...
                <table class="table">
                    ...
                    <tbody class="m-2">
                        <tr>
                            ...
                            <td scope="col"><button type="button" class="btn btn-outline-danger p-1"
                                    style="border-radius: 22px; padding: 6px 12px;">Inactive</button></td>
                        </tr>
                    </tbody>
